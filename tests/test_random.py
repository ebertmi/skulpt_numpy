...
class TestSeed(unittest.TestCase):
    ...
    def test_array(self):
        ...
        self.assertEqual(s.randint(1000), 468)
        s = np.random.RandomState(np.arange(10))
        self.assertEqual(s.randint(1000), 468)
        s = np.random.RandomState([0])
        self.assertEqual(s.randint(1000), 973)
        s = np.random.RandomState([4294967295])
        self.assertEqual(s.randint(1000), 265)

    def test_invalid_scalar(self):
        # seed must be a unsigned 32 bit integers
        self.assertRaises(TypeError, np.random.RandomState, -0.5)
        self.assertRaises(ValueError, np.random.RandomState, -1)

    def test_invalid_array(self):
        # seed must be a unsigned 32 bit integers
        self.assertRaises(TypeError, np.random.RandomState, [-0.5])
        self.assertRaises(ValueError, np.random.RandomState, [-1])
        self.assertRaises(ValueError, np.random.RandomState, [4294967296])
        self.assertRaises(ValueError, np.random.RandomState, [1, 2, 4294967296])
        self.assertRaises(ValueError, np.random.RandomState, [1, -2, 4294967296])
...
class TestBinomial(TestCase):
    ...
    def test_p_is_nan(self):
        # Issue #4571.
        self.assertRaises(ValueError, random.binomial, 1, np.nan)
...
class TestRandomDist(unittest.TestCase):
    ...
    # given seed
    def assertCloseAbs(self, x, y, decimal=1e-9):
    ...
    def test_rand(self):
        ...
        self.assertCloseAbs(actual, desired, decimal=15)
    ...
    def test_randint(self):
        ...
        desired = np.array([[31, 3],
                            [-52, 41],
                            [-48, -66]])
        self.assertCloseAbs(actual, desired)
